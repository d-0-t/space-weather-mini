  ...
  render() {
    return (
      ...
      <div className="pageIntroduction">
        ...
        <p>On the Home page you can find a few interesting highlights and predictions. You can browse the "Forecasts &amp; Discussion" menu for more details.</p>
      </div>
      <div id="homeFlow">
        <div id="homeFlow2" className="homeMini">
          <div id="visual-aurora"><VisualAuroras /></div>
          <div id="geoAlertPage"><GeoAlert /></div>
        </div>
        <div className="homeMini" id="the3DaysPage"><ThreeDaysReport /></div>
      </div>
      </div>
    )
  }
