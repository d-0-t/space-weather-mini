...
import type { LandRing } from "../../../../../products/world-land";

/**
 * Oval glow paint: every non-component definition the Oval glow intensity
 * panel paints through – glow levels, color ramps, legend math, grid/canvas
 * geometry and the canvas paint itself. Lives here so `OvalGlow.tsx` holds
 * one component only; the unit tests import the pure helpers from this
 * module.
 */
