...
/**
 * The L1 reading helpers (transit, time-tag arithmetic, the 5-minute
 * average) live in the pure products module the push sender shares, so the
 * Summary's claims and the Live alert grade the same readings through one
 * seam; these re-exports keep the panel imports stable.
 */
export {
  addMinutes,
  averagedValueAt,
